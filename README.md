...
--> eksctl create cluster --name demo --region <region-name> --version <k8s_version> --nodegroup-name <nodegroup-name> --node-type <ec2-type> --nodes <node-count>
Ex: eksctl create cluster --name demo --region ap-south-1 --version 1.34 --nodegroup-name linux-nodes --node-type t2.micro --nodes 2
...
**Step 2 — Create GitHub OIDC Provider in AWS**:
 ...
 Provider Type ---- OpenID Connect (OIDC is an identity layer on top of OAuth 2.0 and GitHub becomes an Identity Provider (IdP).
